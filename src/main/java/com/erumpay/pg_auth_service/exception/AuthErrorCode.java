...
public enum AuthErrorCode {
	...
	MERCHANT_APPROVAL_NOT_ALLOWED(HttpStatus.CONFLICT, "AUTH-MCH-206", "MERCHANT_APPROVAL_NOT_ALLOWED", "현재 가맹점 상태에서는 승인을 처리할 수 없습니다."),
	...
	MERCHANT_STATUS_SYNC_FAILED(HttpStatus.BAD_GATEWAY, "AUTH-EXT-402", "MERCHANT_STATUS_SYNC_FAILED", "가맹점 상태 동기화에 실패했습니다."),
